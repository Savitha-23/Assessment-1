...
// let depart: string = "Software Testing";
...
// console.log("Final Employee Salary :", 33300);
...
// if (
//     totalSalary >= 35000 && completedTasks >= 10
// ) {
